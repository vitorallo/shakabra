...
- [ ] Fix current development server errors (missing pages, dependencies)
- [ ] Initialize proper Next.js 15 project structure
- [ ] Create required directories (`app/`, `components/`, `lib/`, etc.)

### ⬜ Task 3: Create initial Next.js app structure
- [ ] Setup App Router architecture (`app/` directory)
- [ ] Create root layout and page components
- [ ] Configure Next.js 15 specific features

### ⬜ Task 4: Install and configure dependencies
- [ ] Install TypeScript, Tailwind CSS, ESLint
- [ ] Setup development dependencies and build tools
- [ ] Configure proper package.json scripts
...
- [ ] Setup `next.config.js` with optimization settings
...
- [ ] Store documentation in `/doc/nextjs-15-guide.md`
